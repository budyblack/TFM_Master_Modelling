...
def general_context():
    ...
    places = "{'Gavà': {'Platja de Gavà'}, 'Viladecans': {'La Pineda de Ca'l Francès', 'La Murtra', 'La Pineda Viladecans', 'Platja de l'Estany', 'El Remolar (Viladecans)'}, 'Sant Adrià del Besós': {'Parc del Litoral', 'Mora', 'Fòrum'}, 'Castelldefels': {'Platja de Gavà', 'Baixador', 'La Pineda Castelldefels', 'Lluminetes'}, 'Montgat platges': {'Can Tano', 'Els Toldos', 'Les Barques', 'Montsolís', 'Platja de les Roques', 'Cala Taps'}, 'Badalona sud': {'Mora'}, 'Badalona nort': {'Pont del Petroli', 'Barca Maria', 'Coco', 'Patins a Vela', 'L'Estació", "Pont d'en Botifarreta', 'Cristall', 'Pescadors'}, 'El Prat': {'La Ricarda', 'La Roberta', 'Can Camins', 'El Remolar (El Prat)', 'Platja Naturista', 'Ca l'Arana'}, 'Barcelona - Zona Sud': {'Somorrostro', 'Sant Sebastià', 'Barceloneta', 'Sant Miquel'}, 'Barcelona - Zona Nort': {'Bogatell', 'Nova Icària', 'Llevant', 'Mar Bella', 'Nova Mar Bella'} }"
